...
<body>
	<div>
		...
		<h1 style="text-align:center">Relatório de Departamentos</h1></td>
		...
		<table class="table">
			...
			<tbody>
				<?php 
					$i = 0;
					foreach ($gerarPdfDepartamentos as $relDepto) {
						$dataHora = date('d/m/Y', strtotime($relDepto->data_cadastro));
						switch ($relDepto->situacao) {
						    case 1:
						        $situacao = "ATIVO";
						        break;
						    case 0:
						...
						echo '<tr>';
						echo '<td>' . $relDepto->id_departamento . '</td>';
						echo '<td>' . $relDepto->nome_departamento . '</td>';
						echo '<td>' . $relDepto->observacoes . '</td>';
						echo '<td>' . $situacao . '</td>';
